...
namespace Api.Mailgun.Tests
{
    public class MailingLists
    {
        ...
        {
            var manager = new MailingListManager(Settings.WorkDomain, Settings.ApiKey);

            #region create lists
            var createList1 = await manager.CreateMailingListAsync("test1");
            ...
            var createList2 = await manager.CreateMailingListAsync("test2", "Test list 2");
            ...
            var createList3 = await manager.CreateMailingListAsync("test3", "Test list 3", "Description of the list 3");
            ...
            var createList4 = await manager.CreateMailingListAsync("test4", "Test list 4", "Description of the list 4", AccessLevels.Members);
            ...
            #region update lists
            var updateList1 = await manager.UpdateMailingListAliasAsync("test1", "test1_new");
            ...
            updateList1 = await manager.UpdateMailingListNameAsync("test1_new", "New name");
            Assert.True(updateList1.Successful, updateList1.ErrorMessage);
            Assert.Equal($"test1_new@{Settings.WorkDomain}", updateList1.Response.MailingList.Address);
            ...
            updateList1 = await manager.UpdateMailingListDescriptionAsync("test1_new", "New description");
            Assert.True(updateList1.Successful, updateList1.ErrorMessage);
            Assert.Equal($"test1_new@{Settings.WorkDomain}", updateList1.Response.MailingList.Address);
            Assert.Equal("New name", updateList1.Response.MailingList.Name);
            ...
            updateList1 = await manager.UpdateMailingListAccessAsync("test1_new", AccessLevels.Everyone);
            Assert.True(updateList1.Successful, updateList1.ErrorMessage);
            Assert.Equal($"test1_new@{Settings.WorkDomain}", updateList1.Response.MailingList.Address);
            Assert.Equal("New name", updateList1.Response.MailingList.Name);
            Assert.Equal("New description", updateList1.Response.MailingList.Description);
            ...
            #region add members
            var addMember1 = await manager.AddMemberToListAsync("test1_new", "member1@test.com");
            ...
            var addMember2 = await manager.AddMemberToListAsync("test1_new", "member2@test.com", "Member 2");
            ...
            var addMember3 = await manager.AddMemberToListAsync("test1_new", "member3@test.com", "Member 3", new Dictionary<string, string>() { { "Age", "18" }, { "Gender", "Male" } });
            ...
            var updateMember1 = await manager.UpdateMemberAddressAsync("test1_new", "member1@test.com", "member1_new@test.com");
            ...
            updateMember1 = await manager.UpdateMemberNameAsync("test1_new", "member1_new@test.com", "Member 1 new name");
            Assert.True(updateMember1.Successful, updateMember1.ErrorMessage);
            Assert.Equal("member1_new@test.com", updateMember1.Response.Member.Address);
            ...
            updateMember1 = await manager.UpdateMemberStatusAsync("test1_new", "member1_new@test.com", false);
            Assert.True(updateMember1.Successful, updateMember1.ErrorMessage);
            Assert.Equal("member1_new@test.com", updateMember1.Response.Member.Address);
            Assert.Equal("Member 1 new name", updateMember1.Response.Member.Name);
            ...
            updateMember1 = await manager.UpdateMemberVarsAsync("test1_new", "member1_new@test.com", new Dictionary<string, string>() { { "Weight", "100" } });
            Assert.True(updateMember1.Successful, updateMember1.ErrorMessage);
            Assert.Equal("member1_new@test.com", updateMember1.Response.Member.Address);
            Assert.Equal("Member 1 new name", updateMember1.Response.Member.Name);
            Assert.False(updateMember1.Response.Member.Subscribed);
            ...
            updateMember1 = await manager.UpdateMemberVarsAsync("test1_new", "member1_new@test.com", new Dictionary<string, string>());
            Assert.True(updateMember1.Successful, updateMember1.ErrorMessage);
            Assert.Equal("member1_new@test.com", updateMember1.Response.Member.Address);
            Assert.Equal("Member 1 new name", updateMember1.Response.Member.Name);
            Assert.False(updateMember1.Response.Member.Subscribed);
            ...
            var removeMember = await manager.RemoveMemberFromListAsync("test1_new", "member1_new@test.com");
            ...
            removeMember = await manager.RemoveMemberFromListAsync("test1_new", "member2@test.com");
            Assert.True(removeMember.Successful, removeMember.ErrorMessage);
            Assert.Equal("member2@test.com", removeMember.Response.Address);

            removeMember = await manager.RemoveMemberFromListAsync("test1_new", "member3@test.com");
            Assert.True(removeMember.Successful, removeMember.ErrorMessage);
            Assert.Equal("member3@test.com", removeMember.Response.Address);
            #endregion

            #region remove lists
            var removeList = await manager.DeleteMailingListAsync("test1_new");
            ...
            removeList = await manager.DeleteMailingListAsync("test2");
            Assert.True(removeList.Successful, removeList.ErrorMessage);
            Assert.Equal($"test2@{Settings.WorkDomain}", removeList.Response.Address);

            removeList = await manager.DeleteMailingListAsync("test3");
            Assert.True(removeList.Successful, removeList.ErrorMessage);
            Assert.Equal($"test3@{Settings.WorkDomain}", removeList.Response.Address);

            removeList = await manager.DeleteMailingListAsync("test4");
            Assert.True(removeList.Successful, removeList.ErrorMessage);
